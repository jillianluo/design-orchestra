...
function switchtoPlay() {
  ...
  //clear canvas
  background(250);
  waveCv = document.getElementById("waveCanvas");
  waveCv.scrollIntoView();
  console.log(compose);
  console.log(play);
}
